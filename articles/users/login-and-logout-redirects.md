<!--
{
  ...
  "title": "Redirections de connexion et déconnexion  ",
  "description": "", 
  "author": ""
}
-->
...
![formulaire de menu de déconnexion restreint à l'accès enregistré](../../../en/images/users/login-and-logout-redirects/01-login-redirects-login-form.png)
...
![formulaire de menu de déconnexion restreint à l'accès enregistré](../../../en/images/users/login-and-logout-redirects/02-login-redirects-login-menu-options.png)
...
![formulaire du menu de déconnexion réservé à l'accès enregistré](../../../en/images/users/login-and-logout-redirects/03-login-redirects-logout-menu-options.png)
