...
![Paramètres du plugin CodeMirror](../../../en/images/editors/codemirror-plugin/01-codemirror-plugin-tab.png)

La capture d'écran suivante montre la coloration HTML et le *Contenu CMS* implémenté sous forme de rangée de boutons :

![CodeMirror en utilisation](../../../en/images/editors/codemirror-plugin/02-codemirror-example.png)
