...
![gestionnaire de paquets synaptic](../../../en/images/hosting-local/synaptic-package-manager-gui.png)
...
![page par défaut d'apache](../../../en/images/hosting-local/apache-default-page.png)
