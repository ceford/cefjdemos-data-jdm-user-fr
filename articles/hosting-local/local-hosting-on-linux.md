<!--
{
  ...
  "title": "# Hébergement local sur Linux",
  "description": "", 
  "author": ""
}
-->
...
![gestionnaire de paquets synaptic](../../../en/images/hosting-local/local-hosting-on-linux/01-synaptic-package-manager-gui.png)
...
![page par défaut d'apache](../../../en/images/hosting-local/local-hosting-on-linux/02-apache-default-page.png)
